...
public class ApiHandler implements RequestHandler<Map<String, Object>, Map<String, Object>> {
	...
	public ApiHandler() {
		...
		eventsTable = dynamoDB.getTable("cmtr-ecf0d511-Events-test");
		eventsTable2 = dynamoDB.getTable("cmtr-ecf0d511-Events");
	}
	...
	public Map<String, Object> handleRequest(Map<String, Object> request, Context context) {
		try {
			...
			response.put("body", eventItem.asMap()); // Return the created event
