...
@LambdaLayer(layerName = "sdk_layer", runtime = DeploymentRuntime.JAVA11, artifactExtension = ArtifactExtension.ZIP, libraries = {
		"lib/original-task08-1.0.0.jar" })
...
public class ApiHandler implements RequestHandler<Object, Map<String, Object>> {
	...
	public Map<String, Object> handleRequest(Object request, Context context) {
		...
		try {
			...
			cls = cl.loadClass("com.task08.util.OpenMeteoAPI");
		...
		try {
			...
			weather = (String) method.invoke(openMeteoObj, new Object[] {});
